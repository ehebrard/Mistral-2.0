...
COPTIMIZE = -O3
COMPILFLAGS = -D_UNIX -D_BIT32 -DNDEBUG #-D_PROFILING #-D_DEBUG_SEARCH #-D_DEBUG_PROPAG # -D_DEBUG_PRUNING -D_DEBUG_AC -D_DEBUG_QUEUE #-D_DEBUG_REWRITE #-D_DEBUG_CGRAPH #-D_DEBUG_PROPAG -D_DEBUG_MUL #-D_DEBUG_AC #-D_DEBUG_NOGOOD -D_DEBUG_UNITPROP -D_DEBUG_WATCH #-D_DEBUG_PROPAG #-D_DEBUG_REWRITE #-D_DEBUG_AC  #-D_CHRONOLOGICAL #-D_DEBUG_AC 
